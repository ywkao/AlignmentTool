...
class ESAlignTool : public edm::one::EDAnalyzer<> // public edm::one::EDAnalyzer
{
    ...
    protected:
        ...
        void fill_PredictionState(int, int, int, edm::Handle<reco::TrackCollection>, edm::ESHandle<MagneticField>, edm::ESHandle<GlobalTrackingGeometry>, edm::ESHandle<Propagator> );
        void fill_residual(int);

        double _evt_TooManyReHits;
        double _evt_TooManySelTracks_fill_tracks;
        double _evt_TooManySelTracks_fill_PredictionState;
        bool _debug;
        ...
        Int_t _esRecHit_MatchedTrk_fromOuter[10000][2000];
